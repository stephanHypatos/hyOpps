...
from .routes import auth, executions, organizations, users, partner, metabase_routes
...
app.include_router(metabase_routes.router, prefix="/api/metabase", tags=["metabase"])
